              ...
              <div className="flex flex-wrap w-full">
                <div className="lg:w-2/5 md:w-1/2 md:pr-10 md:py-6">
                  <div className="flex relative pb-12">
                    ...
                    <div className="flex-shrink-0 w-10 h-10 rounded-full bg-[#FB4554] hover:bg-[#0F1822] transition hover:border-2 hover:border-[#FB4554] inline-flex items-center justify-center relative z-10"></div>
                    <div className="flex-grow pl-4">
                      <h2 className="font-medium title-font text-sm text-white mb-1 tracking-wider">
                        Version
                      </h2>
                      <p className="leading-relaxed">{mydata.version}</p>
                    </div>
                  </div>
                  <div className="flex relative pb-12">
                    <div className="h-full w-10 absolute inset-0 flex items-center justify-center">
                    ...
                    <div className="flex-shrink-0 w-10 h-10 rounded-full bg-[#FB4554] hover:bg-[#0F1822] transition hover:border-2 hover:border-[#FB4554] inline-flex items-center justify-center text-white relative z-10"></div>
                    <div className="flex-grow pl-4">
                      <h2 className="font-medium title-font text-sm text-white mb-1 tracking-wider">
                        Build Version
                      </h2>
                      <p className="leading-relaxed">{mydata.buildVersion}</p>
                    </div>
                  </div>
                  <div className="flex relative pb-12">
                    <div className="h-full w-10 absolute inset-0 flex items-center justify-center">
                    ...
                    <div className="flex-grow pl-4">
                      ...
                      <p className="leading-relaxed">{mydata.riotClientVersion}</p>
                    </div>
                  </div>
                  <div className="flex relative pb-12">
                    ...
                    <div className="flex-grow pl-4">
                      ...
                      <p className="leading-relaxed">{mydata.buildDate}</p>
                    </div>
                  </div>
                </div>
                <img
